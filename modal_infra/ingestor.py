...
# Configuration
CACHE_DIR = "/cache"
# Upgrade to LAION-2B (512-dim) for better relevance
...
class VideoWorker:
    ...
    def _get_stream_url(self, url):
        ...
        ydl_opts = {
            ...
            "noplaylist": True,
            "geo_bypass": True,
            # ✨ AUTOMATION: Use Android/iOS client spoofing to bypass "Sign in" requirements without cookies
            "extractor_args": {
                "youtube": {
...
def ingest_video_orchestrator(url: str):
    ...
    ydl_opts = {
        ...
        # ✨ AUTOMATION: Use Android/iOS client spoofing to bypass "Sign in" in orchestrator too
        "extractor_args": {
            "youtube": {
                "player_client": ["android", "ios"], 
            }
